...
export const HoverHome = ({scroll, home}) => {
    return(
        <div className={`absolute transition-all duration-300 -left-32 ${scroll > 1 ? "top-[55px]":"top-[71px]"} top-20 h-36 w-80 ${home ? "grid" : "hidden"} justify-items-center text-base font-normal items-center grid-cols-3 grid-rows-3 bg-white border-t shadow-xl sm:grid-cols-2 sm:grid-rows-none sm:w-52 sm:left-20 sm:z-10 sm:top-0`}>
